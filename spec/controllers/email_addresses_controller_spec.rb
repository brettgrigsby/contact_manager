...
RSpec.describe EmailAddressesController, type: :controller do
  ...
  let(:valid_attributes) {
    {address: 'test@rspec.com', person_id: 1}
  }
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      let(:valid_attributes) { {address: 'bob@test.com', person_id: bob.id} }
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      let(:valid_attributes) { {address: 'test@rspec.com', person_id: bob.id} }
      let(:new_attributes) {
        {address: 'new@address.com', person_id: bob.id}
      }
  ...
  describe "DELETE #destroy" do
    ...
    let(:valid_attributes) { {address: 'testit@testing.com', person_id: bob.id} }
