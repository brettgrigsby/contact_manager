...
RSpec.describe EmailAddressesController, type: :controller do
  ...
  let(:valid_attributes) {
    {address: 'test@rspec.com', contact_id: 1, contact_type: 'Person'}
  }

  let(:invalid_attributes) {
    {address: nil, contact_id: nil, contact_type: 'Person' }
  }
  ...
  describe "POST #create" do
    context "with valid params" do
      let(:bob) { Person.create(first_name: 'Bob', last_name: 'Black')}
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      let(:valid_attributes) { {address: 'test@rspec.com', contact_id: bob.id, contact_type: 'Person'} }
      let(:new_attributes) {
        {address: 'new@address.com', contact_id: bob.id, contact_type: 'Person'}
      }
      ...
      it "updates the requested email_address" do
        ...
        expect(email_address.address).to eq('new@address.com')
  ...
  describe "DELETE #destroy" do
    ...
    let(:valid_attributes) { {address: 'testit@testing.com', contact_id: bob.id, contact_type: 'Person'} }
